    ...
    render() {
        return (
            <div className="netstore-footer">
                ...
                <p>
                    <div className="fcol-sm-offset-1 col-md-offset-1 col-xs-4 col-md-2 col-sm-4" style={{textAlign:"right"}}>{Language.textMap("Address")}:</div>
                    <div className="col-md-9 col-sm-8 col-xs-8">{this.props.address}</div>
                </p>
                <p>
                    <div className="col-sm-offset-1 col-md-offset-1 col-xs-4 col-md-2 col-sm-4" style={{textAlign:"right"}}>{Language.textMap("Phone")}:</div>
